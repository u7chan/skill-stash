...
| # | スキル名 | 概要 |
| --- | --- | --- |
| 1 | agent-ui-streaming | AIエージェントUIのリアルタイム通信をSSE基準で設計・実装する |
| 2 | ai-business-opportunity-finder | 業界と自社の強みからAI事業化領域を探索する |
| 3 | ai-impact-diagnosis | 仕事内容とAI活用状況からAI活用レベルを診断する |
| 4 | ai-transformation-team-designer | 社内AI推進チームを事業成果に直結する形で設計する |
| 5 | ai-workflow-redesign | 業務フローをAI前提で再設計する |
